...
Knowing the PNG file format, I know that the width and height bytes occur after the IHDR bytes. Each gets 4 bytes repsectively, and I can now shorten my image to crop out my hidden message for now. 
